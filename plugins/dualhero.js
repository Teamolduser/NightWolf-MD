...
conn.hero = global.db.data.users[m.sender]
  ...
  if (typeof conn.duelhero[m.sender] != "undefined" && conn.duelhero[m.sender] == true) return m.reply(`*Tidak bisa melakukan pertarungan lagi karena hero anda sedang bertarung.*`)
