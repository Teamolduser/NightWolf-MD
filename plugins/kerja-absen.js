                  ...
                  switch (type) {
                            ...
                            case '3':
                                              // let meqee = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjadua > 1) {
                            ...
                            case '4':
                                              // let meqer = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjatiga > 1) {
                            ...
                            case '5':
                                              // let meqet = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjaempat > 1) {
                            ...
                            case '6':
                                              // let meqey = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjalima > 1) {
                            ...
                            case '7':
                                              // let meqeu = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjaenam > 1) {
                            ...
                            case '8':
                                              // let meqei = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjatujuh > 1) {
                            ...
                            case '9':
                                              // let meqeo = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjadelapan > 1) {
                            ...
                            case '10':
                                              // let meqep = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjasembilan > 1) {
                            ...
                            case '11':
                                              // let meqea = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjasepuluh > 1) {
                            ...
                            case '12':
                                              // let meqes = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjasebelas > 1) {
                            ...
                            case '13':
                                              // let meqed = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjaduabelas > 1) {
                            ...
                            case '14':
                                              // let meqef = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjatigabelas > 1) {
                            ...
                            case '15':
                                              // let meqeg = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjaempatbelas > 1) {
                            ...
                            case '16':
                                              // let meqeh = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjalimabelas > 1) {
                            ...
                            case '17':
                                              // let meqej = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjaenambelas > 1) {
                            ...
                            case '18':
                                              // let meqek = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjatujuhbelas > 1) {
                            ...
                            case '19':
                                              // let meqel = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjadelapanbelas > 1) {
                            ...
                            case '20':
                                              // let meqefh = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjasembilanbelas > 1) {
                            ...
                            case '21':
                                              // let meqez = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjaduapuluh > 1) {
                            ...
                            case '22':
                                              // let meqex = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjaduasatu > 1) {
                            ...
                            case '23':
                                              // let meqec = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjaduadua > 1) {
                            ...
                            case '24':
                                              // let meqev = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjaduatiga > 1) {
                            ...
                            case '25':
                                              // let meqeb = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjaduaempat > 1) {
                            ...
                            case '26':
                                              // let meqen = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjadualima > 1) {
                            ...
                            case '27':
                                              // let meqem = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjaduaenam > 1) {
                            ...
                            case '28':
                                              // let meqse = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjaduatujuh > 1) {
                            ...
                            case '29':
                                              // let meqsu = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjaduadelapan > 1) {
                            ...
                            case '30':
                                              // let meqso = m.sender.replace(/@.+/, '')
                                                  ...
                                                  if (global.db.data.users[m.sender].health > 89) {
                                                  if (global.db.data.users[m.sender].aqua > 4) {
                                                  if (global.db.data.users[m.sender].kerjaduasembilan > 1) {
